...
전면 카메라로 6컷을 자동 촬영하고, 4컷을 골라 프레임에 합성한 뒤,<br>
...
| 라임 | 블랙 | 화이트 |
|:---:|:---:|:---:|
| ![라임](docs/images/frame-lime.png) | ![블랙](docs/images/frame-black.png) | ![화이트](docs/images/frame-white.png) |

| 합성 결과 | 모바일 웹 |
|:---:|:---:|
| ![결과](docs/images/result-sample.png) | ![웹](docs/images/web-mobile.png) |
...
- 행사 일정에 맞춰 빠르게 개발하며 화면 레이아웃은 Figma 시안(834×1194) **좌표 고정 1:1 배치**를 택하였습니다 — 콘텐츠가 변하지 않는 키오스크 특성상 반응형보다 시안 재현 정확도를 우선하였고, 반응형이 필요해지는 시점에는 화면 단위의 스택 레이아웃 전환이 필요합니다
